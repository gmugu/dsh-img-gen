...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-util-value_005f00f2ec004257b269f27fd5e936b4/node_modules/@deepseek-ai/dsh-util-values/lib/index.js
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-settings@0_935f3a2ac52a1f8e83ba61ff4169507a/node_modules/@deepseek-ai/dsh-settings/lib/index.js
var lib_exports = /* @__PURE__ */ __exportAll({
	SettingsConflictError: () => SettingsConflictError,
	SettingsProvider: () => SettingsProvider,
	default: () => SettingsProvider,
	redactSecrets: () => redactSecrets$1
});
/**
...
*/
function redactSecrets$1(schema, value) {
	const secrets = [];
	return {
	...
	*/
	describe(options) {
		return [...this.registrations.values()].map((registration) => {
			...
			const redacted = redactSecrets$1(schema, registration.resolved);
			return {
				...descriptor,
				value: redacted.value,
				...base === void 0 ? {} : { base: redactSecrets$1(schema, base).value },
				...detachedUser === void 0 ? {} : { user: redactSecrets$1(schema, detachedUser).value },
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-typert-pro_32eafa0ce53608e9afb5dafcec019560/node_modules/@deepseek-ai/dsh-typert-protocol/lib/index.js
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-util-crypt_66ec5f64228d8b6b846c0e0318a734f3/node_modules/@deepseek-ai/dsh-util-crypto/lib/index.js
/**
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-brand@0.1.5-rc.1_@deepseek-ai+cordis@4.0.1/node_modules/@deepseek-ai/dsh-brand/lib/index.js
/**
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-timeout@0._5b95bb48758e6032066aa142c5fbb450/node_modules/@deepseek-ai/dsh-timeout/lib/index.js
/** Largest delay Node schedules without clamping it to one millisecond. */
const MAX_TIMER_DELAY_MS = 2147483647;
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-llm@0.1.5-rc.1_@deepseek-ai+cordis@4.0.1/node_modules/@deepseek-ai/dsh-llm/lib/index.js
/**
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-tools@0.1._aaa8ad560a1b4ea9b6e9490b78b8a32d/node_modules/@deepseek-ai/dsh-tools/lib/index.js
/**
...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-credential_bc2d3e5c9a179df7ac53b40c354d894e/node_modules/@deepseek-ai/dsh-credentials/lib/index.js
/**
...
async function fetchDashScopeImageModels(config, apiKey, signal) {
	if (apiKey === void 0) return {
		ok: false,
		reason: "missing-key"
	};
...
*/
async function probeDashScopeWithoutCatalog(config, apiKey, signal) {
	const configured = config.dashscopeEndpoint?.trim() ?? "";
	const base = configured.length > 0 ? configured : DEFAULT_DASHSCOPE_ENDPOINT;
	const compatible = dashscopeCompatibleModelsUrl(base);
	if (compatible !== void 0) {
	...
	const model = config.dashscopeModel?.trim() ?? "qwen-image-3.0";
...
async function probeProviderConnection(provider, config, apiKey, signal) {
	...
	if (provider === "dashscope" && (result.status === 404 || result.status === 405)) return probeDashScopeWithoutCatalog(config, apiKey, signal);
	return result;
}
...
async function serveTestConnection(req, res, deps) {
	...
	if (record(body)?.action === "models") {
		...
		try {
			...
			result = active === "google" ? await fetchGoogleImageModels(deps.config(), apiKey) : active === "dashscope" ? await fetchDashScopeImageModels(deps.config(), apiKey) : await fetchOpenAIImageModels(active, deps.config(), apiKey);
		} catch (error) {
			result = {
				ok: false,
				reason: "error",
...
function apply(ctx, config = {}) {
	let current = () => migrateOpenAICompatConfig(config);
	...
	installImageSettings(ctx, config, {
		setSource: (source) => {
			current = () => migrateOpenAICompatConfig(source());
		},
		onChange: () => {}
	});
	ctx.effect(() => ctx.webServer.register({
